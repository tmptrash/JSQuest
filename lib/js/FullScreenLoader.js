...
Lib.FullScreenLoader = speculoos.Class({
    ...
    _createHtml: function () {
        ...
        container.innerHTML     = '<div style="text-align: center; position: absolute; left: 50%; top: 50%; margin-left: -150px; margin-top: 40px; color: #ffffff; font-family: Verdana; width: 300px;">' + this.cfg.msg + '</div>';
