...
Lib.Terminal = speculoos.Class({
     ...
     */
    initConfig: function () {
        Lib.Terminal.base.initConfig.apply(this, arguments);
    ...
    checkArguments: function (argAmount, cmd, validator) {
        ...
        if (argAmount === null && args.length < 1) {
            throw new Error('Invalid arguments amount. At least one argument is required. See "help connect" for details.');
