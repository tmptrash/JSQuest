...
Lib.Helper = {
     ...
     * Converts point in 3d space into 2d windows where our 3d world is.
     * @param {THREE.Vector3} position Position in 3d space
     * @param camera
     * @param div
     * @return {Object}
     */
    convert3dto2d: function ( position, camera, div ) {
        ...
        return { x: ( pos.x + 1 ) * div.width / 2 + offset.left, y: ( - pos.y + 1) * div.height / 2 + offset.top };
    },
